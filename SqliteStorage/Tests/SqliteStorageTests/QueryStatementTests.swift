...
class QueryStatementTests: XCTestCase {
    ...
    typealias Condition = QueryStatement.Condition
    typealias ConditionSet = QueryStatement.ConditionSet
...
extension QueryStatement.Operator: Equatable {
...
extension QueryStatement.Condition: Equatable {
...
extension QueryStatement.ConditionSet: Equatable {
